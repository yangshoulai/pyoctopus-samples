...
@pyoctopus.hyperlink(
    pyoctopus.link(pyoctopus.css(".item div.hd > a", multi=True, attr="href"), repeatable=False),
...
excel_collector = pyoctopus.excel_collector(
    os.path.expanduser("~/Downloads/movies.xlsx"),
    False,
    columns=[
