...
@pyoctopus.hyperlink(
    pyoctopus.link(
        pyoctopus.xpath('//div[@id="blog-entries"]/article//h2/a/@href', multi=True),
        repeatable=False,
        priority=2,
        attr_props=["category"],
    ),
    pyoctopus.link(
        pyoctopus.xpath('//a[@class="next page-numbers"]/@href', multi=False),
        repeatable=_ALBUMS_PAGE_REPEATABLE,
        priority=3,
    ),
)
class AlbumList:
...
@pyoctopus.hyperlink(
    ...
    pyoctopus.link(
        pyoctopus.xpath('//div[@id="content"]/article//div[@class="separator"]//img/@src', multi=True),
        repeatable=False,
        priority=1,
        inherit=True,
        attr_props=["name", "dir", "category"],
